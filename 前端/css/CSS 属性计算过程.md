...
更详细的来源重要性比较，可以参阅 _MDN_：_[https://developer.mozilla.org/zh-CN/docs/Web/CSS/Cascade](https://developer.mozilla.org/zh-CN/docs/Web/CSS/Cascade)_
...
有关选择器权重的计算方式，不清楚的同学，可以进入此传送门：_[https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity](https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity)_
### 比较次序
