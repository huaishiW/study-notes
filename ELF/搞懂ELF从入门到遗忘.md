...
**补充**：[Section Header Table](概念补充及联想#Section Header Table（节头表）)、[Program Header Table](概念补充及联想#Program Header Table（程序头表）)、[Section](概念补充及联想#Section（节区）)、[Segmment](概念补充及联想#Segment（段）)、
[Section与Segment的核心区别](概念补充及联想#Section与Segment的核心区别)、[为何要将 Section 合并为 Segment](概念补充及联想#为何要将 Section 合并为 Segment)
...
![](ELF/attachments/Pasted%20image%2020260419133516.png)
...
![](ELF/attachments/Pasted%20image%2020260419133807.png)
解读如下：
![](ELF/attachments/Pasted%20image%2020260419133845.png)
![](ELF/attachments/Pasted%20image%2020260419133901.png)
\[1]. 文件类型见 2.1 章节
\[2]. 段没名字，但节是有名字的，节的名字需要另外保存，对应到 .shstrtab 节

**补充**：[magic](概念补充及联想#magic（魔数）)、[解释两个version](概念补充及联想#展示信息中的两个 Version)、

###  3.1.2 程序头表（Program Header Table）
` readelf -l <path/for/elf> `  命令可以查看程序表头的信息。需要注意的是，".o"
文件一般是没有程序表头的。示例如下：
![](ELF/attachments/Pasted%20image%2020260419134026.png)
``` bash
Section to Segment mapping:  
  Segment Sections...  
   00  
...
![](ELF/attachments/Pasted%20image%2020260419134230.png)

**补充**：[【1】Type 取值和含义](概念补充及联想#Type 的取值与含义)、[【3】Align 字段](概念补充及联想#Align 字段的核心作用)、[【3】关联规则（重要）](概念补充及联想#关联规则)

- **Section to Segment mapping**
展示了段包含哪些节，常关注的是代码段和数据段。下表只是个典型的例子，一个实际的更复杂的代码段可能包含更多的节。
![](ELF/attachments/Pasted%20image%2020260419134316.png)

###  3.1.3 节头表（Section Header Table）
**` readelf -S <path/for/elf> ` ** 命令可以查看节表头的信息，示例如下：
![](ELF/attachments/Pasted%20image%2020260419134344.png)
...
![](ELF/attachments/Pasted%20image%2020260419134516.png)
![](ELF/attachments/Pasted%20image%2020260419134536.png)
...
![](ELF/attachments/Pasted%20image%2020260419134818.png)
...
![](ELF/attachments/Pasted%20image%2020260419134949.png)
###  3.2.4 .data
...
![](ELF/attachments/Pasted%20image%2020260419135058.png)
